...
Whole-body PBPK model of the antibody–drug conjugate BAY-794620 in mice.  
PK-Sim model without extension to represent tumor tissue as descried in Ref. [1].
...
**The latest release of the snapshot of the model, the evaluation plan and the static content can be found [here](https://github.com/Open-Systems-Pharmacology/BAY794620-Model/releases/latest).**
